...
@WithMockUser(
        ...
        authorities = {"ROLE_PLANNER", "IMPORT_EXECUTE"})
class WorkbookImportPostgresIntegrationTest {
    ...
    void ensureTestPlannerOwner() {
        jdbc.update(
                "INSERT INTO app_user(username,password_hash,display_name,enabled) VALUES(?,?,?,TRUE) ON CONFLICT (username) DO NOTHING",
                "test-planner",
                "{noop}test",
                "测试排课员");
        jdbc.update(
                "INSERT INTO app_user_role(user_id,role_id) SELECT u.id,r.id FROM app_user u CROSS JOIN app_role r WHERE u.username=? AND r.code='PLANNER' ON CONFLICT DO NOTHING",
                "test-planner");
    }
    ...
    void importEndpointsRequireImportPermission() throws Exception {
        mockMvc.perform(
                        get("/api/imports/templates/master-data.xlsx")
                                .with(
                        ...
                        get("/api/imports/templates/master-data.xlsx")
                                .with(
                                        org.springframework.security.test.web.servlet.request
                                                ...
                                                .roles("PLANNER")))
                .andExpect(status().isForbidden());
        mockMvc.perform(get("/api/imports/templates/master-data.xlsx")).andExpect(status().isOk());
    }
    ...
    void previewThenConfirmImportsAllBusinessSheetsInOneFlow() throws Exception {
        ...
        org.assertj.core.api.Assertions.assertThat(count("teaching_requirement", "REQ-900"))
                .isEqualTo(1);
        ...
        org.assertj.core.api.Assertions.assertThat(
                        jdbc.queryForObject(
                                "SELECT status FROM import_batch WHERE id = ?",
                                String.class,
                                batchId))
                .isEqualTo("IMPORTED");
    }
    ...
    void previewThenConfirmImportsMasterDataV1AcrossAllSheets() throws Exception {
        ...
        String preview =
                mockMvc.perform(multipart("/api/imports/preview").file(file).with(csrf()))
                        ...
                        .andExpect(
                                jsonPath("$.schemaHash")
                                        .value(MasterDataSchemaRegistry.schemaHash()))
        ...
        org.assertj.core.api.Assertions.assertThat(
                        jdbc.queryForObject(
                                "SELECT active FROM teacher WHERE code='T910'", Boolean.class))
                .isTrue();
        org.assertj.core.api.Assertions.assertThat(
                        jdbc.queryForObject(
                                "SELECT student_count FROM student_group WHERE code='G9-10'",
                                Integer.class))
                .isEqualTo(36);
        org.assertj.core.api.Assertions.assertThat(
                        jdbc.queryForObject(
        ...
        org.assertj.core.api.Assertions.assertThat(
                        jdbc.queryForObject(
                                "SELECT student_count FROM teaching_requirement WHERE code='REQ-910'",
                                Integer.class))
                .isEqualTo(30);
        org.assertj.core.api.Assertions.assertThat(
                        jdbc.queryForObject(
        ...
        org.assertj.core.api.Assertions.assertThat(
                        jdbc.queryForObject(
                                "SELECT available FROM room_availability a JOIN room r ON r.id=a.room_id JOIN academic_term term ON term.id=a.term_id WHERE r.code='B210' AND term.code='2026-FALL' AND a.period_code='MON-2'",
                                Boolean.class))
                .isTrue();
        org.assertj.core.api.Assertions.assertThat(count("room_feature_catalog", "LAB"))
                .isEqualTo(1);
        org.assertj.core.api.Assertions.assertThat(
                        jdbc.queryForObject(
                                "SELECT COUNT(*) FROM room_feature rf JOIN room r ON r.id=rf.room_id WHERE r.code='B210' AND rf.feature_code='LAB'",
                                Integer.class))
                .isEqualTo(1);
        org.assertj.core.api.Assertions.assertThat(
                        jdbc.queryForObject(
                                "SELECT COUNT(*) FROM teaching_requirement_feature f JOIN teaching_requirement r ON r.id=f.teaching_requirement_id WHERE r.code='REQ-910' AND f.feature_code='LAB'",
                                Integer.class))
                .isEqualTo(1);
        org.assertj.core.api.Assertions.assertThat(
                        jdbc.queryForObject(
                                "SELECT COUNT(*) FROM activity_group_member m JOIN activity_group g ON g.id=m.activity_group_id WHERE g.code='ACT-910'",
                                Integer.class))
                .isEqualTo(2);
        org.assertj.core.api.Assertions.assertThat(
                        jdbc.queryForObject(
                                "SELECT member_index FROM activity_group_member m JOIN activity_group g ON g.id=m.activity_group_id JOIN teaching_requirement r ON r.id=m.teaching_requirement_id WHERE g.code='ACT-910' AND r.code='REQ-911'",
                                Integer.class))
                .isEqualTo(1);
    }
    ...
    void masterDataWithoutOptionalSheetsImportsCoreDataAndPreservesExistingRoom() throws Exception {
        jdbc.update(
                "INSERT INTO room(code,name,capacity,room_type,active) VALUES(?,?,?,?,TRUE) ON CONFLICT (code) DO NOTHING",
                "KEEP-ROOM",
                "已有教室",
                40,
                "普通教室");
        ...
        org.assertj.core.api.Assertions.assertThat(count("teaching_requirement", "REQ-MIN-1"))
                .isEqualTo(1);
    ...
    void confirmStateChangeIsAtomicForAlreadyImportedBatch() throws Exception {
        ...
        org.assertj.core.api.Assertions.assertThat(
                        jdbc.queryForObject(
                                "SELECT COUNT(*) FROM teaching_requirement WHERE code = 'REQ-902'",
                                Integer.class))
                .isEqualTo(1);
    }
    ...
    void masterDataRequiresChineseHeaders() throws Exception {
        ...
        try (XSSFWorkbook workbook =
                        new XSSFWorkbook(new ByteArrayInputStream(chinese.getBytes()));
                ByteArrayOutputStream output = new ByteArrayOutputStream()) {
            workbook.getSheet("教师").getRow(0).getCell(0).setCellValue("code");
            workbook.write(output);
            MockMultipartFile english =
    ...
    private MockMultipartFile masterDataWithoutGroupSheet(String suffix) throws Exception {
        try (XSSFWorkbook workbook = new XSSFWorkbook();
            ...
            sheet(
                    ...
                    "说明",
                    new String[] {"说明"},
                    new String[] {"MASTER_DATA v1 invalid fixture"});
            sheet(
                    workbook,
                    "教师",
                    MasterDataSchemaRegistry.headers("教师").toArray(String[]::new),
    ...
    private MockMultipartFile masterDataWorkbook() throws Exception {
        try (XSSFWorkbook workbook = new XSSFWorkbook();
            ...
            sheet(
                    ...
                    "说明",
                    new String[] {"说明"},
                    new String[] {"MASTER_DATA v1 test fixture"});
            sheet(
                    workbook,
                    "教师",
                    MasterDataSchemaRegistry.headers("教师").toArray(String[]::new),
                    new String[] {"T910", "实验教师", "TRUE"});
            sheet(
                    workbook,
                    "班级",
                    MasterDataSchemaRegistry.headers("班级").toArray(String[]::new),
            ...
            sheet(
                    ...
                    "课程",
                    MasterDataSchemaRegistry.headers("课程").toArray(String[]::new),
                    new String[] {"SCI10", "科学", "TRUE"});
            sheet(
                    workbook,
                    "教室",
                    MasterDataSchemaRegistry.headers("教室").toArray(String[]::new),
                    new String[] {"B210", "实验室 B210", "40", "实验室", "TRUE"});
            SheetBuilder requirements =
                    new SheetBuilder(
                            workbook,
                            "教学需求",
                            MasterDataSchemaRegistry.headers("教学需求").toArray(String[]::new));
            ...
            SheetBuilder availability =
                    new SheetBuilder(
                            workbook,
                            "资源可用性",
                            MasterDataSchemaRegistry.headers("资源可用性").toArray(String[]::new));
            availability.row("TEACHER", "T910", "2026-FALL", "MON-1", "FALSE");
            availability.row("ROOM", "B210", "2026-FALL", "MON-2", "TRUE");
            sheet(
                    workbook,
                    "特征目录",
                    MasterDataSchemaRegistry.headers("特征目录").toArray(String[]::new),
                    new String[] {"LAB", "实验室", "TRUE"});
            sheet(
                    workbook,
                    "教室特征",
                    MasterDataSchemaRegistry.headers("教室特征").toArray(String[]::new),
                    new String[] {"B210", "LAB", "TRUE"});
            sheet(
                    workbook,
                    "教学需求特征",
                    MasterDataSchemaRegistry.headers("教学需求特征").toArray(String[]::new),
                    new String[] {"REQ-910", "LAB", "TRUE"});
            SheetBuilder activities =
                    new SheetBuilder(
                            workbook,
                            "活动组",
                            MasterDataSchemaRegistry.headers("活动组").toArray(String[]::new));
    ...
    private MockMultipartFile workbook(
        ...
        try (XSSFWorkbook workbook = new XSSFWorkbook();
            ...
            SheetBuilder roomSheet =
                    new SheetBuilder(workbook, "教室", new String[] {"code", "name", "capacity"});
            roomSheet.row(room, "导入教室", "50");
            SheetBuilder requirementSheet =
                    new SheetBuilder(
                            workbook,
                            "教学需求",
                            new String[] {
