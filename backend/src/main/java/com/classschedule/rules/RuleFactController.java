...
public class RuleFactController {
    ...
    public ResponseEntity<?> availabilityList(@RequestParam(defaultValue = "2026-FALL") String termCode) {
        try {
    ...
    public Object activityGroups(@RequestParam(defaultValue = "2026-FALL") String termCode) { return repository.listActivityGroups(termCode); }

    @DeleteMapping("/activity-groups/{code}")
    public ResponseEntity<?> deleteActivityGroup(@PathVariable String code) { return execute(() -> repository.deleteActivityGroup(code)); }
