...
public class ScheduleRuleController {
    ...
    public ScheduleRuleController(ScheduleRuleRepository repository) {
        this.repository = repository;
    }

    @GetMapping
    public Object list(@RequestParam(required = false) String termCode) {
        return repository.list(termCode);
    }
