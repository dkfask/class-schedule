...
import com.classschedule.schedule.ScheduleOptions;
...
public class ScheduleVersionQueryController {
    ...
    public ScheduleVersionQueryController(ScheduleRepository versions, ScheduleOptionsRepository options) {
        this.versions = versions; this.options = options;
    }
