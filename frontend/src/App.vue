  ...
  <div v-if="auth.isAuthenticated" class="app-shell">
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <RouterLink to="/workspace" class="nav-item" active-class="active">
        ...
        <RouterLink v-if="auth.isPlanner" to="/rule-facts" class="nav-item" active-class="active">
          <span class="nav-icon">◫</span>
          <span class="nav-title">规则事实</span>
        </RouterLink>

        <div class="nav-section-title">第三阶段 · 交付</div>
        <RouterLink v-if="auth.isPlanner" to="/versions" class="nav-item" active-class="active">
          <span class="nav-icon">◷</span>
